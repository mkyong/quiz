...
function QuestionEditor({ number, question, setQuestion, onRemove }) {
  ...
  const handleExplainChange = (e) => setQuestion({ ...question, correctOptionExplain: e.target.value });
  ...
  return (
    <div className="bg-neutral-100 dark:bg-neutral-800 p-4 rounded-xl shadow flex flex-col gap-3">
      <div className="flex justify-between items-center">
        <span className="text-xs text-neutral-500 dark:text-neutral-400 font-semibold">Question {number}</span>
      ...
      <textarea className="border border-neutral-300 dark:border-neutral-700 rounded-xl px-3 py-2 font-mono min-h-[140px] w-full resize-y bg-white dark:bg-neutral-900 text-neutral-900 dark:text-neutral-100" 
        value={question.text} onChange={handleTextChange} required />
      ...
      <div className="text-xs text-neutral-500 dark:text-neutral-400 mb-2 font-semibold">Explanation</div>
      <textarea className="border border-neutral-300 dark:border-neutral-700 rounded-xl px-3 py-2 font-mono min-h-[140px] w-full resize-y bg-white dark:bg-neutral-900 text-neutral-900 dark:text-neutral-100" 
        value={question.correctOptionExplain} onChange={handleExplainChange} required />
